...
static const double inactiveopacity =
    0.925f; /* Window opacity when it's inactive (0 <= opacity <= 1) */
static Bool bUseOpacity =
    True; /* Starts with opacity on any unfocused windows */
static char *fonts[] = {"Fantasque Sans Mono:size=17",
...
// static const char col_4[]  = "#924441"; /* border color focused windows and
// tags */
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_0, toggleopacity, {0}},
